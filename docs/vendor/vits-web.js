const u = "https://huggingface.co/diffusionstudio/piper-voices/resolve/main", B = "./vendor/", x = "./vendor/piper_phonemize", c = {
...
async function N(e, m) {
  h = h ?? await import("./piper-DeOu3H9E.js"), _ = _ ?? await import("./ort.wasm.min.js");
